...
fun TqNavigationBar(
    ...
    topBorder: Dp = 1.dp,
    borderColor: Color = MaterialTheme.tqColorsPalette.divider,
...
@Composable
fun RowScope.TqNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
    ...
    val styledIcon = @Composable {
        val iconColor by animateColorAsState(
            if (selected) MaterialTheme.tqColorsPalette.primary else MaterialTheme.tqColorsPalette.contentTertiary,
        )
        icon(iconColor)
    }
    ...
    val styledLabel = @Composable {
        ...
        val style = MaterialTheme.tqTypography.labelSmall.copy(color = textColor)
        label?.let {
            it(style)
        }
    }
