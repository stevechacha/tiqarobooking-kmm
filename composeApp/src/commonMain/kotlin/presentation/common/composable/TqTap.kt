...
fun TqTap(
    ...
    Box(
        modifier
            .border(
                width = 1.dp, color = MaterialTheme.tqColorsPalette.contentBorder, shape = RoundedCornerShape(
            ...
            .height(40.dp)
            .background(
                color = MaterialTheme.tqColorsPalette.background,
        ...
        Card(
            modifier = Modifier
                .fillMaxWidth(.5f)
                .fillMaxHeight()
                .padding(MaterialTheme.tqDimens.space4)
        ...
        Row(
            ...
            Text(
                ...
                color = if (selectedTab == 1) Color.White else MaterialTheme.tqColorsPalette.contentTertiary,
            ...
            Text(
                text = secondTabLabel,
                style = MaterialTheme.tqTypography.titleMedium,
                color = if (selectedTab == 2) Color.White else MaterialTheme.tqColorsPalette.contentTertiary,
                textAlign = TextAlign.Center,
                modifier = Modifier.clickable(
                    indication = null,
                    interactionSource = remember { MutableInteractionSource() }
